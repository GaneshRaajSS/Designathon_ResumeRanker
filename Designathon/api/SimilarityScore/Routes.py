...
from db.Schema import SimilarityScoreResponse, SimilarityScoreEnriched
...
@router.get("/jd/{jd_id}/similarity-scores", response_model=list[SimilarityScoreEnriched])
